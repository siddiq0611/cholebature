...
// ─── Light palette (clean white/grey) ─────────────────────────────────────────
class LightColors {
...
// ─── Category accent colors (icons/text/borders only) ─────────────────────────
class CategoryColors {
  // Expense (8 — all clearly distinct)
  static const food = Color(0xFFFF5252);        // vivid red
  static const travel = Color(0xFF9E9E9E);      // neutral grey
  static const essentials = Color(0xFF66BB6A);  // medium green
  static const work = Color(0xFFFFCA28);        // amber yellow
  static const misc = Color(0xFFAB47BC);        // purple
  static const shop = Color(0xFFFF7043);        // deep orange
  static const home = Color(0xFF26C6DA);        // teal/cyan
  static const health = Color(0xFFEC407A);      // hot pink

  // Income (blue, green, red, yellow)
...
// ─── App-level color accessor ──────────────────────────────────────────────────
extension AppColors on BuildContext {
  bool get isDark => Theme.of(this).brightness == Brightness.dark;

  Color get appBg => isDark ? DarkColors.bg : LightColors.bg;
  Color get appSurface => isDark ? DarkColors.surface : LightColors.surface;
  ...
  Color get appBorrowed => isDark ? DarkColors.borrowed : LightColors.borrowed;
}